...
export function AboutContent() {
  return (
    <div className="pb-40 text-white">
      ...
      <section className="relative -mt-[12dvh] overflow-hidden border-t border-white/5 bg-[#050505] pb-32 pt-[calc(12dvh+12rem)] text-center md:pb-40 md:pt-[calc(12dvh+18rem)]">
